...
if (len(sys.argv)<4):
	print("Erreur: Veuillez entrez trois parametre:L'adresse du fichier,l'option '4d' ou '8d' et '-s' ou '-p' enfin ajoutez '-inv' pour inverser l'image.")
	sys.exit()
...
#image = matrice_f(image)
#image = io.imread("chevalnb.png")
#image = image.astype(int)
#image = matrice_f(args[1])
print("Image definie")
x=(len(image))
y=(len(image[0]))
